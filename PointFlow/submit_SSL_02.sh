...
for alpha_step_option_random_num in "${alpha_step_option_random_num_list[@]}"; do
        ...
        output_folder=results_manipulation/"$cates"/"$contrastive_SSL"_"$embedding_function"/"$num_direction"_"$alpha_step_option"_"$alpha_step_option_random_num"_"$alpha_01"_"$alpha_02"_"$alpha_03"
